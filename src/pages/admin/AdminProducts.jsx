...
const AdminProducts = () => {
  const products = [
    ...
    { id: 2, name: 'Product 2', category: 'Clothing', price: 49.99, stock: 0, status: 'Out of Stock' },
    { id: 3, name: 'Product 3', category: 'Home', price: 149.99, stock: 25, status: 'Active' },
    { id: 4, name: 'Product 4', category: 'Sports', price: 79.99, stock: 100, status: 'Active' },
    { id: 5, name: 'Product 5', category: 'Books', price: 19.99, stock: 200, status: 'Active' },
  ];
    ...
    <AdminLayout>
      <div className="space-y-6">
        ...
        <Card>
          ...
          <Table
            headers={['ID', 'Name', 'Category', 'Price', 'Stock', 'Status', 'Actions']}
          >
